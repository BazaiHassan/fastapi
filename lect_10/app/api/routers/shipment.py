...
async def submit_shipment(shipment: ShipmentCreate, service: ShipmentServiceDep, _:SellerDep):
    return await service.add(shipment_create=shipment)


@router.patch("/", response_model=ShipmentRead)
async def update_shipment(
    id: int, shipment_update: ShipmentUpdate, service: ShipmentServiceDep, _:SellerDep
):
...
@router.delete("/")
async def delete_shipment(id: int, service: ShipmentServiceDep, _:SellerDep):
